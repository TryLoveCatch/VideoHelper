...
public class BrowserUnit {
    ...
    public static final int MESSAGE_PAGE_START = 101;
    public static final int MESSAGE_PAGE_FINISH = 102;
    public static final int MESSAGE_SHOULDLOAD_URL = 103;
    public static final int MESSAGE_PAGE_RECEIVE_TITLE = 105;
    public static final int MESSAGE_LOAD_RESOURCE = 106;

    public static final int MESSAGE_OPEN_URL = 111;
    ...
    public static final String SEARCH_ENGINE_SOUKU = "http://www.soku.com/search_video/q_";
    public static final String SEARCH_ENGINE_IQIYI = "http://m.iqiyi.com/search.html?source=input&vfrm=2-3-0-1&key=";

    public static final String UA_DESKTOP_WINDOWS = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.115 Safari/537.36";
    public static final String UA_DESKTOP_IOS = "Mozilla/5.0 (iPhone; CPU iPhone OS 8_0 like Mac OS X) AppleWebKit/600.1.3 (KHTML, like Gecko) Version/8.0 Mobile/12A4345d Safari/600.1.4";
    public static final String UA_DESKTOP_IPAD = "Mozilla/5.0 (iPad; CPU OS 4_3_5 like Mac OS X; en-us) AppleWebKit/533.17.9 (KHTML, like Gecko) Version/5.0.2 Mobile/8L1 Safari/6533.18.5";
    public static final String UA_DESKTOP_AOS = "Mozilla/5.0 (Linux; Android 4.2.2; GT-I9505 Build/JDQ39) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/31.0.1650.59 Mobile Safari/537.36";
    ...
    public static String queryWrapper(Context context, String query) {
        ...
        switch (i) {
            ...
            case 5:
                return custom + query;
            case 6:
                return SEARCH_ENGINE_SOUKU + query;
            default:
                return SEARCH_ENGINE_BAIDU + query;
        }
    }
    ...
    public static String urlWrapper(String url) {
        ...
        if (url.startsWith(BrowserUnit.URL_SCHEME_HTTPS)) {
            String scheme = green500.replace("{content}", android.luna.net.videohelper.Ninja.Unit.BrowserUnit.URL_SCHEME_HTTPS);
            url = scheme + url.substring(8);
        } else if (url.startsWith(android.luna.net.videohelper.Ninja.Unit.BrowserUnit.URL_SCHEME_HTTP)) {
            String scheme = gray500.replace("{content}", android.luna.net.videohelper.Ninja.Unit.BrowserUnit.URL_SCHEME_HTTP);
    ...
    public static void copyURL(Context context, String url) {
        ...
        ToastUtils.show(context, R.string.toast_copy_successful);
    }
    ...
    public static void download(Context context, String url, String contentDisposition, String mimeType) {
        try {
            ...
            ToastUtils.show(context, R.string.toast_start_download);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static String checkSite(String url) {
        ...
        if (!StringUtils.isBlank(url)) {
            if (url.contains("youku.")) {
                site = GlobalConstant.SITE_YOUKU;
            } else if (url.contains("acfun.")) {
                site = GlobalConstant.SITE_ACFUN;
            } else if (url.contains("tudou.")) {
                site = GlobalConstant.SITE_TUDOU;
            } else if (url.contains("iqiyi.")) {
                site = GlobalConstant.SITE_IQIYI;
            } else if (url.contains("sohu.")) {
                site = GlobalConstant.SITE_SOHU;
            } else if (url.contains("qq.")) {
                site = GlobalConstant.SITE_QQ;
            } else if (url.contains("sohu.")) {
                site = GlobalConstant.SITE_SOHU;
            } else if (url.contains("mgtv.")) {
                site = GlobalConstant.SITE_MANGO;
            } else if (url.contains("wasu.")) {
                site = GlobalConstant.SITE_WASU;
            } else if (url.contains("fun.tv")) {
                site = GlobalConstant.SITE_FUN;
            } else if (url.contains("le.com")) {
                site = GlobalConstant.SITE_LETV;
            } else if (url.contains("letv.com")) {
                site = GlobalConstant.SITE_LETV;
            } else if (url.contains(".bilibili.")) {
                site = GlobalConstant.SITE_BILIBILI;
            } else if (url.contains(".pptv.")) {
                site = GlobalConstant.SITE_PPTV;
            } else if (url.contains(".yinyuetai.com")) {
                site = GlobalConstant.SITE_YINYUETAI;
            } else if (url.contains(".meiyouad.com")) {
                site = GlobalConstant.SITE_BAIKAN;
            } else {
                site = "";
            }
        }
