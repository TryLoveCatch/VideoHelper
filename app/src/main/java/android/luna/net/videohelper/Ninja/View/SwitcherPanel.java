...
public class SwitcherPanel extends ViewGroup {
    ...
    public void setFlingVelocity(int flingVelocity) {
        ...
        if (dragHelper != null) {
            dragHelper.setMinVelocity(android.luna.net.videohelper.Ninja.Unit.ViewUnit.dp2px(getContext(), flingVelocity));
        }
    }
    ...
    public SwitcherPanel(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        shadowDrawable = android.luna.net.videohelper.Ninja.Unit.ViewUnit.getDrawable(getContext(), R.drawable.shadow_below);
        ...
        int windowHeight = android.luna.net.videohelper.Ninja.Unit.ViewUnit.getWindowHeight(context);
        int statusBarHeight = android.luna.net.videohelper.Ninja.Unit.ViewUnit.getStatusBarHeight(context);
    ...
    public void draw(Canvas canvas) {
        ...
        if (anchor == Anchor.TOP) {
            ...
            bottom = top + ((int) (android.luna.net.videohelper.Ninja.Unit.ViewUnit.dp2px(getContext(), shadowHeight)));
        } else {
            bottom = (int) (mainView.getBottom() - dimen48dp);
            top = bottom - ((int) (android.luna.net.videohelper.Ninja.Unit.ViewUnit.dp2px(getContext(), shadowHeight)));
        }
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            if (!keyBoardShowing && omnibox.getVisibility() == VISIBLE && shouldCollapsed()) {
                ...
                if (anchor == Anchor.TOP && deltaY >= android.luna.net.videohelper.Ninja.Unit.ViewUnit.dp2px(getContext(), 32)) {
                    collapsed();
                    return true;
                } else if (anchor == Anchor.BOTTOM && deltaY <= -android.luna.net.videohelper.Ninja.Unit.ViewUnit.dp2px(getContext(), 32)) {
                    collapsed();
                    return true;
                }
            }
    ...
    private void applyParallaxForCurrentSlideOffset() {
        if (parallaxOffset > 0) {
            float offset = android.luna.net.videohelper.Ninja.Unit.ViewUnit.dp2px(getContext(), parallaxOffset);
            if (anchor == Anchor.TOP) {
