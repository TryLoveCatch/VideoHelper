...
public class MediaScanner {
  ...
  public void scanDirectories(String[] directories) {
    try {
      ...
      VitamioLog.d(" prescan time: %dms", prescan - start);
      VitamioLog.d("    scan time: %dms", scan - prescan);
      VitamioLog.d("postscan time: %dms", end - scan);
      VitamioLog.d("   total time: %dms", end - start);
    } catch (SQLException e) {
      VitamioLog.e("SQLException in MediaScanner.scan()", e);
    } catch (UnsupportedOperationException e) {
      VitamioLog.e("UnsupportedOperationException in MediaScanner.scan()", e);
    } catch (RemoteException e) {
      VitamioLog.e("RemoteException in MediaScanner.scan()", e);
    }
  }
  ...
  public Uri scanSingleFile(String path, String mimeType) {
    try {
      ...
      VitamioLog.e("RemoteException in MediaScanner.scanFile()", e);
      return null;
    }
  }
  ...
  static {
    ...
    VitamioLog.i("LIB ROOT: %s", LIB_ROOT);
  ...
  private class MyMediaScannerClient implements MediaScannerClient {
    ...
    public void handleStringTag(String name, byte[] valueBytes, String valueEncoding) {
      ...
      try {
        ...
        VitamioLog.e("handleStringTag", e);
        value = new String(valueBytes);
      }
      VitamioLog.i("%s : %s", name, value);
    ...
    public void setMimeType(String mimeType) {
      VitamioLog.i("setMimeType: %s", mimeType);
      mMimeType = mimeType;
