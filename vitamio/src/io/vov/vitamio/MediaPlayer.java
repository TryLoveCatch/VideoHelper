...
public class MediaPlayer {
  ...
  public MediaPlayer(Context ctx, boolean preferHWDecoder) {
    ...
    if (preferHWDecoder) {
      ...
      try {
        ...
        VitamioLog.e("unloadOMX failed %s", e.toString());
      }
  ...
  static {
    ...
    try {
      ...
      if (!vvo_loaded) {
        ...
        VitamioLog.d("FALLBACK TO VVO JNI " + vvo_loaded);
      }
      loadVAO_native( LIB_ROOT +  "libvao.0.so");
    } catch (java.lang.UnsatisfiedLinkError e) {
      VitamioLog.e("Error loading libs", e);
    }
  }
  ...
  private SparseArray<MediaFormat> parseTrackInfo(byte[] tracks, String encoding) {
    ...
    try {
      ...
      VitamioLog.e("getTrackMap exception");
...
//        //Log.i("MiuiVideo: get message after player released, msg type: " + msg.what);
      ...
      switch (msg.what) {
        ...
        case MEDIA_SET_VIDEO_SIZE:
          ...
          return;
        case MEDIA_ERROR:
          VitamioLog.e("Error (%d, %d)", msg.arg1, msg.arg2);
          ...
          return;
        case MEDIA_INFO:
          VitamioLog.i("Info (%d, %d)", msg.arg1, msg.arg2);
          if (mOnInfoListener != null)
            mOnInfoListener.onInfo(mMediaPlayer, msg.arg1, msg.arg2);
          return;
        case MEDIA_CACHE:
        ...
        case MEDIA_TIMED_TEXT:
          ...
          if (mData.getInt(MEDIA_SUBTITLE_TYPE) == SUBTITLE_TEXT) {
            VitamioLog.i("Subtitle : %s", mData.getString(MEDIA_SUBTITLE_STRING));
        ...
        case MEDIA_HW_ERROR:
        	...
        	return;
        default:
          VitamioLog.e("Unknown message type " + msg.what);
          return;
      }
    }
  }
